...
The angular2-seed project ships with a `.travis.yml` that you can use to run continous integration for this tutorial
through https://travis-ci.org/[Travis CI]. To enable builds on Travis CI, go to your account and enable builds for the
